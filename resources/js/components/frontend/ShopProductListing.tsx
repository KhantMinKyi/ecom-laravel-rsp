...
const ProductCard: React.FC<{
  ...
  return (
    <div className="group relative flex flex-col h-full rounded-xl overflow-hidden bg-white dark:bg-gray-500 shadow-md hover:shadow-xl transition-all duration-300">
...
const ShopProductListing = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8 bg-gradient-to-b ">
