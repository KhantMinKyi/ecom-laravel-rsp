...
export default function ShopHeader() {
  ...
  return (
    <header className=" w-full">
      <nav
        className={cn(
          "flex flex-col w-full bg-white dark:bg-gray-900 transition-all duration-300",
          isScrolled && "shadow-md fixed top-0 left-0 right-0 z-50"
        )}
      >
        {/* Main navigation bar */}
        <div className="border-b border-sky-100 dark:border-gray-800">
          <div
            className={cn(
          ...
          <div className="container mx-auto">
            ...
            <div className="md:hidden w-full relative mb-1">
              <Button
                variant="ghost"
                size="sm"
                className="text-gray-600 hover:text-black hover:bg-gray-100 flex justify-start w-full pl-3 pr-4 py-1.5 rounded-md dark:text-white dark:hover:text-white dark:hover:bg-gray-800"
      ...
      {isMenuOpen && (
        <>
          ...
          />
          <div className="fixed inset-y-0 left-0 z-50 w-[280px] bg-white shadow-xl animate-in slide-in-from-left duration-300 md:hidden overflow-auto dark:bg-gray-900">
